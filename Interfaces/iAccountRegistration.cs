...
namespace Connect.Libraries.UserManagement.Interfaces
{
    ...
    public interface iAccountRegistration
    {
        ...
        bool ValidateRegistration(ref HttpServerUtility Server, ref HttpResponse Response, ref HttpRequest Request, UserInfo objUser, ProfilePropertyDefinitionCollection profileProperties, List<string> errorMessages);
        ...
        void FinalizeAccountRegistration(ref HttpServerUtility Server, ref HttpResponse Response, ref HttpRequest Request, UserInfo objUser);
    }
}