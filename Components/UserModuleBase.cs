...
namespace Connect.Libraries.UserManagement
{
    public class ConnectUsersModuleBase : PortalModuleBase
    {
        ...
        protected bool CompareFirstNameLastName
        {
            get
            {
                if (Settings["CompareFirstNameLastName"] != null)
                {
        ...
        protected bool ValidateEmailThroughRegex
        {
            get
            {
                if (Settings["ValidateEmailThroughRegex"] != null)
                {
        ...
        protected string[] ShowUserDetailTabs
        {
            get
            {
                ...
                if (Settings["ShowUserDetailTabs"] != null)
                {
                    try
                    {
        ...
        protected string ExternalInterface
        {
            get
            {
                if (Settings["ExternalInterface"] != null)
                {
        ...
        protected DisplaynameUpdateMode DisplaynameMode
        {
            get
            {
                if (Settings["ShowDisplayName"] != null)
                {
        ...
        protected string AddToRoleStatus
        {
            get
            {
                if (Settings["AddToRoleStatus"] != null)
                {
                    try
                    {
        ...
        protected bool IsValidProperty(UserInfo objUser, ProfilePropertyDefinition ProfProperty, ref Control objControl)
        {
            ...
            if (ctl != null)
            {
                ...
                {
                    if (((RadDateTimePicker)ctl).DbSelectedDate != null)
                    {
                        return true;
                    }
                    else
                ...
                {
                    if (((RadDatePicker)ctl).DbSelectedDate != null)
                    {
                        return true;
                    }
                    else
        ...
        {
            if (objRoot.ID != null && objRoot.ID.StartsWith(id))
            {
                return objRoot;
            }
        ...
        protected List<string> GetPropertyValueList(ProfilePropertyDefinition PropertyDefinition)
        {
            ...
            if (DataCache.GetCache("dnnwerk_ValueList_" + PropertyDefinition.PropertyDefinitionId.ToString()) != null)
            {
                            ...
                            case "user":
                                {
                                    ...
                                    blnNeedsIndicator = true;
                                    if (strKey.ToLower() == "username" && objUser != null)
                                    {
                ...
                case "checkboxlist":
                    {
                        ...
                        try
                        {
                            ...
                            {
                                if (chklist.Items.FindByValue(item) != null)
                                {
        ...
        public void ManageRegionLabel(ref Control Container)
        {
            ...
            if (ctlRegionDrop != null)
            {
                if (ctlRegionDrop.Visible == true)
                {
                    if (objLabelForDropdown != null)
                        objLabelForDropdown.Visible = true;
                    if (objLabelForTextbox != null)
        ...
        protected void drpCountry_SelectedIndexChanged(object o, EventArgs e)
        {
            ...
            if (ctlRegionDrop != null && entries != null)
            {
